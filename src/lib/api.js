...
export const billingAPI = {
  ...
  getReceipts: (id) => api.get(`/billing/purchases/${id}/receipts`),
  confirmPurchase: (id, data = {}) => api.post(`/billing/purchases/${id}/confirm`, data),
  cancelPurchase: (id) => api.post(`/billing/purchases/${id}/cancel`),
  voidPurchase: (id) => api.post(`/billing/purchases/${id}/void`),
  refundPurchase: (id) => api.post(`/billing/purchases/${id}/refund`),
  quoteInstructionPayment: (data) => api.post('/billing/instruction-payments/quote', data),
  createInstructionPayment: (data) => api.post('/billing/instruction-payments', data),
  payInstructionPayment: (id, data) => api.post(`/billing/instruction-payments/${id}/pay`, data),
  cancelInstructionPayment: (id) => api.post(`/billing/instruction-payments/${id}/cancel`),
  getInstructionPaymentReceipts: (id) => api.get(`/billing/instruction-payments/${id}/receipts`),
  voidInstructionPayment: (id) => api.post(`/billing/instruction-payments/${id}/void`),
  refundInstructionPayment: (id) => api.post(`/billing/instruction-payments/${id}/refund`),
